...
from SR.SRGAN.utils import convert_image
from SR.SRGAN.model.models import Generator
from SR.SRGAN.model.models import SRResNet
import time
from PIL import Image

# 测试图像
imgPath = './image/test.jpeg'
...
if __name__ == '__main__':
    ...
    srresnet.load_state_dict(checkpoint['nets'])
    srresnet.eval()
    model = srresnet
