...
from SR.SRGAN.model.srgan import Generator, Discriminator, TruncatedVGG19
from SR.SRGAN.datasets import SRDataset
from SR.SRGAN.utils import adjust_learning_rate, AverageMeter, convert_image
...
# checktpoint='results/checkpoint_srgan.pth'
workers = 4  # 加载数据线程数量
...
def main():
    ...
    generator.net.load_state_dict(srresnetcheckpoint['nets'])
    ...
    for epoch in range(start_epoch, epochs + 1):
        ...
        for i, (lr_imgs, hr_imgs) in enumerate(train_loader):
            ...
            # 打印结果
            print(f"第{i}/{n_iter}个batch结束", end='\r')
